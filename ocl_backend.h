#ifndef I_SAM_OPENCL_OCL_BACKEND_H
#define I_SAM_OPENCL_OCL_BACKEND_H
...
struct ocl_backend {
    ...
    cl_ulong global_mem;
    int is_gpu;
    int profile; /* Per-kernel timing (I_SAM_OPENCL_PROFILE set). */
};
...
#endif /* I_SAM_OPENCL_OCL_BACKEND_H */
